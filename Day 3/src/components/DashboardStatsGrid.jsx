	...
	return (
		<div className="flex gap-4">
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Total Admissions</span>
			...
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Total Colleges</span>
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">4300</strong>
						<span className="text-sm text-green-500 pl-2"></span>
					</div>
				</div>
			</BoxWrapper>
			<BoxWrapper>
				...
				<div className="pl-4">
					...
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">1313</strong>
